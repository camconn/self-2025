...
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/floatn.h:79:24: warning: unsupported type: 'Complex'
pub const __cfloat128 = @compileError("unable to resolve typedef child type");
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/floatn.h:79:24
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:74:7: warning: struct demoted to opaque type - has bitfield
...
pub const count_t = c_ulong;
pub export var ccount: count_t = @import("std").mem.zeroes(count_t);
pub export var wcount: count_t = @import("std").mem.zeroes(count_t);
pub export var lcount: count_t = @import("std").mem.zeroes(count_t);
pub export var total_ccount: count_t = 0;
pub export var total_wcount: count_t = 0;
pub export var total_lcount: count_t = 0;
pub fn error_print(arg_perr: c_int, arg_fmt: [*c]u8, arg_ap: [*c]struct___va_list_tag_2) callconv(.c) void {
    var perr = arg_perr;
    _ = &perr;
    var fmt = arg_fmt;
    _ = &fmt;
...
// wc.c:36:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn errf(fmt: [*c]u8, ...) void;
// wc.c:48:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn perrf(fmt: [*c]u8, ...) void;
pub export fn report(arg_file: [*c]u8, arg_ccount_1: count_t, arg_wcount_2: count_t, arg_lcount_3: count_t) void {
    var file = arg_file;
    _ = &file;
    var ccount_1 = arg_ccount_1;
    _ = &ccount_1;
    var wcount_2 = arg_wcount_2;
    _ = &wcount_2;
    var lcount_3 = arg_lcount_3;
    _ = &lcount_3;
    _ = printf("%6lu %6lu %6lu %s\n", lcount_3, wcount_2, ccount_1, file);
}
pub fn isword(arg_c: u8) callconv(.c) c_int {
    var c = arg_c;
    _ = &c;
    return @as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, c)));
    ...
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISalpha)))))));
}
pub export fn getword(arg_fp: ?*FILE) c_int {
    var fp = arg_fp;
    _ = &fp;
    ...
    while ((blk: {
        ...
        if (isword(@as(u8, @bitCast(@as(i8, @truncate(c))))) != 0) {
            wcount +%= 1;
            break;
        }
        ccount +%= 1;
    ...
    while (c != -@as(c_int, 1)) : (c = getc(fp)) {
        ccount +%= 1;
        if (c == @as(c_int, '\n')) {
            lcount +%= 1;
        }
        if (!(isword(@as(u8, @bitCast(@as(i8, @truncate(c))))) != 0)) break;
    }
    return @intFromBool(c != -@as(c_int, 1));
}
pub export fn counter(arg_file: [*c]u8) void {
    var file = arg_file;
    _ = &file;
    var fp: ?*FILE = fopen(file, "r");
    _ = &fp;
    if (!(fp != null)) {
        perrf(@as([*c]u8, @ptrCast(@volatileCast(@constCast("cannot open file `%s'")))), file);
    }
    ccount = blk: {
        const tmp = blk_1: {
            const tmp_2 = @as(count_t, @bitCast(@as(c_long, @as(c_int, 0))));
            lcount = tmp_2;
            break :blk_1 tmp_2;
        };
        wcount = tmp;
...
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    ...
    _ = &i;
    if (argc < @as(c_int, 2)) {
        errf(@as([*c]u8, @ptrCast(@volatileCast(@constCast("usage: wc FILE [FILE...]")))));
    }
    {
        i = 1;
        while (i < argc) : (i += 1) {
    ...
    if (argc > @as(c_int, 2)) {
        report(@as([*c]u8, @ptrCast(@volatileCast(@constCast("total")))), total_ccount, total_wcount, total_lcount);
    }
    return 0;
}
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/features.h:199:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:45:10
pub inline fn __glibc_has_builtin(name: anytype) @TypeOf(__has_builtin(name)) {
    _ = &name;
    return __has_builtin(name);
}
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:55:10
pub const __LEAF = "";
pub const __LEAF_ATTR = "";
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:82:11
pub const __COLD = @compileError("unable to translate macro: undefined identifier `__cold__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:102:11
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:131:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token '#'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:132:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:151:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:370:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:371:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:379:10
pub const __glibc_c99_flexarr_available = @as(c_int, 1);
pub const __REDIRECT = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:410:10
pub const __REDIRECT_NTH = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:417:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:419:11
pub const __ASMNAME = @compileError("unable to translate C expr: unexpected token ','");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:422:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:452:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:463:10
pub const __attribute_alloc_align__ = @compileError("unable to translate macro: undefined identifier `__alloc_align__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:469:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__pure__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:479:10
pub const __attribute_const__ = @compileError("unable to translate C expr: unexpected token '__attribute__'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:486:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__unused__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:492:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__used__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:501:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__noinline__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:502:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:510:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:520:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__format_arg__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:533:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__format__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:543:10
pub const __attribute_nonnull__ = @compileError("unable to translate macro: undefined identifier `__nonnull__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:555:11
pub inline fn __nonnull(params: anytype) @TypeOf(__attribute_nonnull__(params)) {
    _ = &params;
    return __attribute_nonnull__(params);
}
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__returns_nonnull__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:568:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__warn_unused_result__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:577:10
pub const __wur = "";
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__always_inline__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:595:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__artificial__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:604:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:622:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:623:11
pub const __fortify_function = __extern_always_inline ++ __attribute_artificial__;
pub const __restrict_arr = @compileError("unable to translate C expr: unexpected token '__restrict'");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:666:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:715:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:792:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:793:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:807:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:808:10
pub const __HAVE_GENERIC_SELECTION = @as(c_int, 1);
pub const __fortified_attr_access = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:853:11
pub const __attr_access = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:854:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:855:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token ''");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:865:10
pub const __attr_dealloc_free = "";
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__returns_twice__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:872:10
pub const __attribute_struct_may_alias__ = @compileError("unable to translate macro: undefined identifier `__may_alias__`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/sys/cdefs.h:881:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/floatn.h:66:12
...
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/floatn.h:120:12
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/types.h:137:10
...
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/select.h:34:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const _RWLOCK_INTERNAL_H = "";
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token '{'");
// /usr/lib64/zig/0.14.0/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/thread-shared-types.h:112:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:105:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:109:9
...
// /usr/lib64/zig/0.14.0/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /usr/lib64/zig/0.14.0/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /usr/lib64/zig/0.14.0/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /usr/lib64/zig/0.14.0/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /usr/lib64/zig/0.14.0/lib/include/__stdarg_va_copy.h:11:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/ctype.h:102:9
pub const __tobody = @compileError("unable to translate macro: undefined identifier `__res`");
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/ctype.h:155:9
...
// /usr/lib64/zig/0.14.0/lib/libc/include/generic-glibc/ctype.h:244:10
...
pub const COUNT = @compileError("TODO postfix inc/dec expr");
// wc.c:72:9
